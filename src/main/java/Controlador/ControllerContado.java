...
public class ControllerContado {

    private ArrayList<Contado> ventas; // Lista para almacenar las ventas
    private JFVentaContaddo vista; // Vista de la venta al contado

    public ControllerContado(JFVentaContaddo vista) {
        this.vista = vista;
