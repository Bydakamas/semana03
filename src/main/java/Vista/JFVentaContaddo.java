...
import Controlador.ControllerContado;
 ...
 * @author USER 17
 */
public class JFVentaContaddo extends javax.swing.JFrame {

    /**
     * Creates new form JFVentaContaddo
     */
    
    private ControllerContado controlador;
    
    
    public JFVentaContaddo() {
        initComponents();
        
        controlador = new ControllerContado(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFVentaContaddo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFVentaContaddo().setVisible(true);
            }
        });
    }
